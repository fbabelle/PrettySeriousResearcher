...
2. **Confirm it exists as cited.** Title, authors, year, and venue must match the citation. A near-match (right authors, wrong year; right title, wrong venue) is a *defect to correct*, not a pass — fix the metadata to the resolved source.
